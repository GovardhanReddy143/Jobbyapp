...
class JobItemDetails extends Component {
    ...
    return (
      <div className="job-item-error-view-container">
        ...
        <p className="job-item-failure-description">
          We cannot seem to find the type you are looking for
        </p>
    ...
    return (
      <div className="job-details-view-container">
        <div className="job-item">
          ...
          <h1 className="life_at_company-heading">Life at Company</h1>
          <div className="life_at_company-description-image-conatiner">
            <p className="life_at_company-description">{description}</p>
            <img
              src={imageUrl}
              alt="life at company"
              className="life_at_company-image"
            />
          </div>
        </div>
  ...
  render() {
    return (
      <>
        <Header />
        <div className="job-item-details-conatiner">
